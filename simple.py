...
from sampler import SuperSampler,MixedSampler,UCSFSampler
...
wandb.init(project="simple", entity="jmanasse", config = {
...
def train(feature_extractor,  classifier_ucsf, train_loader, test_loader,final_test_loader, fold ):
...
if __name__ == '__main__':
    ...
    for fold in range(0,5):
        ...
        test_acc, test_accuracy_class, test_accuracy_dataset, best_accuracy, best_epoch, best_models = train(feature_extractor,  classifier_ucsf, train_loader,  test_loader, final_test_loader, fold = fold)
